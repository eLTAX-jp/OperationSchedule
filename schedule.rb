...
def insert_header(body)
    body.div(class:"table-header") do
        body.div(class:"table-header1") do
            body.span("", class:"table-header-l")
            body.span("#{YEAR}(#{wareki(YEAR)})年度", class:"table-header1-r")
        end
        body.div(class:"table-header2") do
            body.span("", class:"table-header-l")
...
def insert_day_box(body, a_day, table_range)
    ...
    body.span(class:"day-box#{cls}") do
        # 日
...
def main(args)
    ...
    File.write("schedule.html", doc.to_html, external_encoding:"UTF-8")
